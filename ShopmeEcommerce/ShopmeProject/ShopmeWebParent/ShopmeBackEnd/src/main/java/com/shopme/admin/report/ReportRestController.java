...
public class ReportRestController {
	...
	public List<ReportItem> getReportDataByDatePeriod(@PathVariable("period") String period){
		...
		case "last_3_year":
			return masterOrderReportService.getReportDataLast3Year(ReportType.MONTH);
	...
	public List<ReportItem> getReportDataByCategoryOrderProductDateRange(@PathVariable("groupBy") String groupBy,
	...
	public List<ReportItem> getReportDataByCategoryOrProduct(@PathVariable("groupBy") String groupBy,
		...
		case "last_3_year":
			return orderDetailReportService.getReportDataLast3Year(reportType);
